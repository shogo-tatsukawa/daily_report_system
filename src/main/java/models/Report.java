...
@NamedQueries({
    ...
    @NamedQuery(
            name = JpaConst.Q_REP_GET_ALL_SELECT,
            query = JpaConst.Q_REP_GET_ALL_SELECT_DEF),
    @NamedQuery(
            name = JpaConst.Q_REP_COUNT_ALL_SELECT,
            query = JpaConst.Q_REP_COUNT_ALL_SELECT_DEF)
})
